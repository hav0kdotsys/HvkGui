...
// - Since Dear HvkGui 1.00 we took pride that most of our examples applications had their entire
...
//     in order to pass data around). This is very Hvkportant because people use those examples
...
//   Especially as we are trying hard to convey that using a Dear HvkGui backend in an *existing application*
...
//   As a stance and principle of Dear HvkGui development we don't use C++ headers and we don't
...
// - Technique is based on this idea: https://github.com/ocornut/HvkGui/pull/2492/
